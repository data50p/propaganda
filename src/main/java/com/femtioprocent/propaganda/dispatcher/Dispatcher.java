...
public class Dispatcher {
	...
	if (orig_connector == null) { // FederationServer
	    return dispatchMsg1(datagram, avoid);
	}
     ...
     */
    private synchronized int dispatchMsg1(Datagram datagram, PrintWriter avoid) {
	...
	server.sendToFed(datagram.toString(), avoid);
